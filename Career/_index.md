...
[`Technologies/Playbooks/internship-applications.md`](../Technologies/Playbooks/internship-applications.md)
(the workflow) and [`Technologies/Templates/internship-tracker.md`](../Technologies/Templates/internship-tracker.md)
(the tracker) — not duplicated here.

## AI prompts for this module

In [`Technologies/Prompt-Library/Career/`](../Technologies/Prompt-Library/Career):
...
[`Technologies/Prompt-Library/Interview/`](../Technologies/Prompt-Library/Interview) and
[`Technologies/Prompt-Library/System-Design/`](../Technologies/Prompt-Library/System-Design)
