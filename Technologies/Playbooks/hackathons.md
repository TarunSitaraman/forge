...
## AI prompts
- `../Prompt-Library/Hackathons/hackathon-idea-triage.md`
- `../Prompt-Library/Hackathons/hackathon-execution-timeline.md`
- `../Prompt-Library/Presentations/demo-script-design.md`
