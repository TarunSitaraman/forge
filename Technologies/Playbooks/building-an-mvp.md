...
- `../Prompt-Library/Decision-Making/decision-tradeoff-matrix.md` — for the iterate/pivot/stop call
- `../Prompt-Library/AI/llm-feature-feasibility-check.md` — if the MVP involves an LLM feature
