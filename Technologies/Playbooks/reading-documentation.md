...
## AI prompts
- `../Prompt-Library/Software-Engineering/legacy-code-onboarding.md` — adapt for a docs set instead of a codebase
- `../Prompt-Library/Research/paper-critical-reading.md` — for docs that are more conceptual/design-oriented
