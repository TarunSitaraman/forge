...
## AI prompts
- `../Prompt-Library/Competitive-Programming/cp-problem-pattern-recognition.md` — adapt for pattern-recognition-heavy subjects (math, CS theory)
- `../Prompt-Library/Research/paper-critical-reading.md` — adapt for dense reading-heavy exam material
