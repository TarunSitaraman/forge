...
- `../Prompt-Library/Architecture/scalability-stress-test-review.md`
- `../Prompt-Library/Architecture/architecture-decision-record.md`
- `../Prompt-Library/Architecture/service-boundary-analysis.md`

## Expected artifacts
- A design doc under `Technologies/` or the relevant `Projects/<name>/`
- One or more ADRs
