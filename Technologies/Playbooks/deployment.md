...
## Checklist
Use `../Templates/deployment-checklist.md` directly — this playbook
...
## AI prompts
- `../Prompt-Library/Azure/azure-devops-pipeline-hardening.md` — if hardening the pipeline itself
- `../Prompt-Library/Docker/dockerfile-review.md` — if this deploy ships a container image
- `../Prompt-Library/Debugging/production-incident-triage.md` — if something goes wrong post-deploy
...
## Deliverables
- A completed `../Templates/deployment-checklist.md` for this deploy
