...
yet — see `Technologies/Playbooks/starting-a-software-project.md`.}
...
link out to a full `../Templates/architecture-document.md` rather
...
`../Templates/project-plan.md` for a fuller planning doc if this
...
exists and hasn't gone stale, using `../Templates/readme.md` and
`../Templates/api-documentation.md` as the underlying templates
where applicable.}

## Useful prompts

{Link the specific `../Prompt-Library/` entries you've actually
used on this project — not a generic list, only ones that proved useful
here, so future-you doesn't have to rediscover them.}

- `../Prompt-Library/{category}/{prompt}.md` — {why it was useful here}

## Useful links

{Docs, RFCs, Stack Overflow answers, or `../Docs/` reference pages
...
{Pull from `../Prompt-Library/Decision-Making/premortem-analysis.md`
...
a real `Technologies/Playbooks/`-style runbook.}

## Demo

{Link to a demo video/live instance. If you scripted a demo, link
`../Prompt-Library/Presentations/demo-script-design.md` output here.}
...
`../Templates/portfolio-project.md` to write it up, and link the
result here.}

## GitHub checklist

- [ ] README follows `../Templates/readme.md`
...
- Keep Architecture and Tech Stack as summaries; link to fuller docs
  (`../Templates/architecture-document.md`) instead of duplicating
