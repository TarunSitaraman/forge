...
1. Copy [`project-notebook.md`](project-notebook.md) into
   ...
   see `Technologies/Playbooks/starting-a-software-project.md` for the full
...
to `../Templates/architecture-document.md`,
`../Templates/project-plan.md`, or a full ADR only when a section
genuinely outgrows a summary.

## Relationship to other Systems modules

- **Kickoff process:** `Technologies/Playbooks/starting-a-software-project.md`
- **Fuller architecture doc (if needed):** `../Templates/architecture-document.md`
- **Fuller project plan (if needed):** `../Templates/project-plan.md`
- **Demo scripting:** `../Prompt-Library/Presentations/demo-script-design.md`
- **Portfolio write-up:** `../Templates/portfolio-project.md`
- **Risk analysis:** `../Prompt-Library/Decision-Making/premortem-analysis.md`
- **Deployment process:** `Technologies/Playbooks/deployment.md` and `../Templates/deployment-checklist.md`
- **Retrospective (standalone, e.g. a team sprint retro):** `../Templates/retrospective.md`
- **Documentation reference:** `../Templates/readme.md` and `../Templates/api-documentation.md`
