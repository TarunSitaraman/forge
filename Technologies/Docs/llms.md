...
- Treat the context window as a real resource budget — don't dump
  ...
  attention to what matters (see `../Docs/rag.md` on retrieval
  dilution).
...
- Ignoring prompt injection risk when untrusted content (documents,
  ...
  `../Prompt-Library/Prompt-Engineering/prompt-injection-hardening.md`.
...
- `../Docs/prompt-engineering.md` for how to work effectively within
  this mental model.
- `../Docs/rag.md` for grounding an LLM in external knowledge.
- `../Prompt-Library/AI/` and `../Prompt-Library/Prompt-Engineering/`
