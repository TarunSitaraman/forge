...
- **Diagnosing every bad answer as a prompt problem.** Most RAG failures
  ...
  prompt. See `../Prompt-Library/RAG/rag-architecture-review.md`.
...
- Build a real labeled eval set (see
  `../Prompt-Library/AI/prompt-eval-harness-design.md`) and measure
...
- `../Prompt-Library/RAG/rag-architecture-review.md` and
  `chunking-strategy-design.md` for the diagnostic and design prompts
  that operationalize this document.
- `../Docs/llms.md` for the underlying model behavior RAG is
