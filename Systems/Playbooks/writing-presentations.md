...
## AI prompts
- `Systems/Prompt-Library/Presentations/presentation-narrative-arc.md`
- `Systems/Prompt-Library/Writing/dense-prose-tightening.md` — for slide text itself
- `Systems/Prompt-Library/Writing/technical-explainer-for-non-experts.md` — if audience is non-technical
