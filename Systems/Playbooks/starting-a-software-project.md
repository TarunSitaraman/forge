...
4. Build the scope-cut plan (see `Systems/Prompt-Library/Project-Planning/project-scope-cut-plan.md`)
...
## AI prompts
- `Systems/Prompt-Library/Architecture/architecture-decision-record.md` — for any early irreversible technical choice
- `Systems/Prompt-Library/Project-Planning/project-scope-cut-plan.md` — for the scope plan in step 4
- `Systems/Prompt-Library/System-Design/system-design-interview-style.md` — for structuring the initial architecture
