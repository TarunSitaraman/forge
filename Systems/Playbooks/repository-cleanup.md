...
3. Review branches: merge or close anything stale, following the
   ...
   `Systems/Prompt-Library/Software-Engineering/pr-review-senior-engineer.md`'s
...
8. Open this as a reviewable PR (or a small number of them, grouped
   ...
   `Systems/Prompt-Library/Git/commit-history-cleanup.md` for keeping the
   changes reviewable.

## AI prompts
- `Systems/Prompt-Library/Software-Engineering/code-simplification-pass.md` — for simplifying code found along the way
- `Systems/Prompt-Library/Git/commit-history-cleanup.md`
- `Systems/Prompt-Library/Documentation/technical-doc-outline-from-code.md` — if the README/docs need real restructuring, not just fixes
