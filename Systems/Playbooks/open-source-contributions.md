...
## AI prompts
- `Systems/Prompt-Library/Software-Engineering/legacy-code-onboarding.md` — for fast orientation in the target project
- `Systems/Prompt-Library/Software-Engineering/pr-review-senior-engineer.md` — self-review your PR before submitting
