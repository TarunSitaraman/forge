...
(`Systems/Project-System/project-notebook.md`, for a single project's
...
`Systems/Prompt-Library/Debugging/root-cause-five-whys.md` framing if a
...
see `Systems/Templates/meeting-notes.md` for the same discipline applied
to any meeting.)*
