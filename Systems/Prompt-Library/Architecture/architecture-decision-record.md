...
## Expected output
A complete ADR: context, options with tradeoffs, decision, consequences — ready to drop into `Systems/`.
...
- Store the resulting ADR in `Systems/` immediately; a decision not written down will be re-litigated later.
