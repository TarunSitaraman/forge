...
`Systems/Career/cold-email-templates.md` as a starting structure.
...
## Tips
- Keep it under 150 words — the tips folder in `Systems/Career/cold-email-templates.md` exists precisely because longer cold emails get skimmed and dropped.
