...
memory (see `Systems/Docs/llms.md`) — everything it needs for THIS call
...
- **Temperature/sampling**: see `Systems/Docs/llms.md` — a prompt-
...
`Systems/Prompt-Library/Prompt-Engineering/prompt-failure-diagnosis.md`
...
`Systems/Prompt-Library/AI/prompt-eval-harness-design.md` for building a
...
- Version-control prompts like code; review changes, and test them
  ...
  `Systems/Prompt-Library/AI/prompt-eval-harness-design.md`).
- Keep a single prompt focused on one task; a prompt trying to handle
  ...
  `Systems/Prompt-Library/Prompt-Engineering/system-prompt-design-review.md`).
...
- `Systems/Docs/llms.md` for the underlying model behavior this practice
  is built on.
- `Systems/Prompt-Library/Prompt-Engineering/` for the operational
