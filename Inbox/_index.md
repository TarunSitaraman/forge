...
*Fast, unsorted capture. A queue, not storage.*

Drop anything here that needs to be captured now but filed later: a
half-formed idea, a link, a snippet, a decision to revisit. One file per
item, or a running `capture.md` for very short entries — your call, but
keep it fast.
