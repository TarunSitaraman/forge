...
## Overview
Ordered binary tree where left subtree keys are smaller and right subtree keys are larger.
...
## Use Cases
Use to understand ordered maps and tree invariants; prefer balanced variants in production.
