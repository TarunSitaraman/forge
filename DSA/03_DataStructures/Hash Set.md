...
type: data-structure
status: stable
tags: [dsa/data-structure, dsa/hash-set]
canonical: true
related: [[Hashing]], [[Graph Traversal]], [[Two Pointers]
---
# Hash Set

## Overview
Hash-backed membership collection storing unique keys.
...
- Remove key
- Test membership
- Deduplicate a stream of values

## Complexity
expected add/remove/contains O(1). Always analyze the operation actually used by the algorithm, not only the headline average case.
...
## Use Cases
Use for visited state, deduplication, and membership tests.
...
## Related Patterns
- [[Hashing]], [[Graph Traversal]], [[Two Pointers]]
- [[Pattern Index]]
