...
## Overview
Nearly complete tree stored in an array that exposes the minimum or maximum priority.
...
## Use Cases
Use for dynamic best-candidate selection without fully sorting all items.
