...
## Overview
Contiguous indexed sequence with O(1) random access and strong cache locality.
...
## Use Cases
Use when order and indexed access dominate structural updates.
...
## Related Patterns
- [[Binary Search]], [[Sliding Window]], [[Prefix Sum]], [[Two Pointers]]
- [[Pattern Index]]
