...
## Overview
Array-backed tree for prefix aggregates with point updates.
...
## Use Cases
Use for dynamic prefix sums, frequency tables, and order statistics over compressed coordinates.
