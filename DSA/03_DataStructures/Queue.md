...
## Overview
First-in-first-out collection for processing items in arrival or layer order.
...
## Use Cases
Use for level-order traversal, unweighted shortest path, and producer-consumer flow.
