...
status: stable
tags: [dsa/interview, dsa/common-pitfalls]
canonical: true
...
## Purpose
This page captures durable interview guidance for Common Pitfalls. Keep it practical, concise, and linked to canonical DSA pages rather than repeating theory.
