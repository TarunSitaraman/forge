...
status: stable
tags: [dsa/interview, dsa/whiteboarding]
canonical: true
...
## Purpose
This page captures durable interview guidance for Whiteboarding. Keep it practical, concise, and linked to canonical DSA pages rather than repeating theory.
