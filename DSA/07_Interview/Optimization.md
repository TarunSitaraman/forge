...
status: stable
tags: [dsa/interview, dsa/optimization]
canonical: true
...
## Purpose
This page captures durable interview guidance for Optimization. Keep it practical, concise, and linked to canonical DSA pages rather than repeating theory.
