...
status: stable
tags: [dsa/interview, dsa/communicating-thought-process]
canonical: true
...
## Purpose
This page captures durable interview guidance for Communicating Thought Process. Keep it practical, concise, and linked to canonical DSA pages rather than repeating theory.
