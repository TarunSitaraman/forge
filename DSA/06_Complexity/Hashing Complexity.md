...
type: complexity
status: stable
tags: [dsa/complexity, dsa/hashing-complexity]
canonical: true
related: [[[Hashing]], [[Hash Map]], [[Hash Set]]]
---
# Hashing Complexity

## Concept
Expected and worst-case behavior of hash tables and hash-based algorithms.

## Reasoning Model
Expected O(1) assumes a good hash distribution; worst-case collision patterns can degrade operations.
