...
type: complexity
status: stable
tags: [dsa/complexity, dsa/sorting-complexity]
canonical: true
related: [[[Merge Sort]], [[Quick Sort]], [[Counting Sort]], [[Radix Sort]]]
---
# Sorting Complexity

## Concept
Lower bounds and practical costs for ordering data.

## Reasoning Model
Comparison sorts require Omega(n log n) in the general case; non-comparison sorts trade on key constraints.
