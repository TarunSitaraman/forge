...
type: complexity
status: stable
tags: [dsa/complexity, dsa/recurrence-relations]
canonical: true
related: [[[Master Theorem]], [[Divide and Conquer]], [[Recursion]]]
---
# Recurrence Relations

## Concept
Equations describing recursive runtime in terms of smaller inputs.

## Reasoning Model
Identify number of subproblems, subproblem size, combine cost, and base case.
...
## Related Algorithms
- [[Master Theorem]], [[Divide and Conquer]], [[Recursion]]
- [[Algorithm Index]]
