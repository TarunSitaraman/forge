...
type: complexity
status: stable
tags: [dsa/complexity, dsa/tree-complexity]
canonical: true
related: [[[Tree]], [[Binary Search Tree]], [[Binary Lifting]]]
---
# Tree Complexity

## Concept
Complexity shaped by node count, height, branching factor, and augmentation.

## Reasoning Model
Balanced height gives logarithmic path operations; unbalanced trees can degrade to linear height.
...
## Related Algorithms
- [[Tree]], [[Binary Search Tree]], [[Binary Lifting]]
- [[Algorithm Index]]
