...
type: complexity
status: stable
tags: [dsa/complexity, dsa/time-complexity]
canonical: true
related: [[[Big O]], [[Recurrence Relations]], [[Graph Complexity]]]
---
# Time Complexity

## Concept
Resource model for how operation count grows with input size.

## Reasoning Model
Count dominant operations, account for nested loops, recursion, data-structure operations, and amortized costs.
...
## Related Algorithms
- [[Big O]], [[Recurrence Relations]], [[Graph Complexity]]
- [[Algorithm Index]]
