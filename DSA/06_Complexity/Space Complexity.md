...
type: complexity
status: stable
tags: [dsa/complexity, dsa/space-complexity]
canonical: true
related: [[[Big O]], [[Tree Complexity]], [[Graph Complexity]]]
---
# Space Complexity

## Concept
Auxiliary memory growth beyond the input, including recursion stack and maintained state.

## Reasoning Model
Separate input storage from extra memory unless the problem explicitly asks for total memory.
...
## Related Algorithms
- [[Big O]], [[Tree Complexity]], [[Graph Complexity]]
- [[Algorithm Index]]
