...
type: complexity
status: stable
tags: [dsa/complexity, dsa/amortized-analysis]
canonical: true
related: [[[Dynamic Array]], [[Heap]], [[Hash Map]]]
---
# Amortized Analysis

## Concept
Average cost over a sequence of operations, even when individual operations are expensive.

## Reasoning Model
Use aggregate, accounting, or potential methods to show rare expensive work is paid for by many cheap operations.
