...
type: complexity
status: stable
tags: [dsa/complexity, dsa/master-theorem]
canonical: true
related: [[[Recurrence Relations]], [[Merge Sort]], [[Binary Search]]]
---
# Master Theorem

## Concept
Shortcut for divide-and-conquer recurrences of the form T(n)=aT(n/b)+f(n).

## Reasoning Model
Compare f(n) with n^(log_b a) and verify regularity before applying a case.
...
## Related Algorithms
- [[Recurrence Relations]], [[Merge Sort]], [[Binary Search]]
- [[Algorithm Index]]
