...
canonical: true
related: [[[Python - Greedy]], [[Heap]], [[Sorting]], [[Interval Processing]], [[Greedy Cheat Sheet]]]
---
# Greedy

## Intuition
Make locally optimal choices when an exchange argument or invariant proves global optimality.

## When To Use
Intervals, scheduling, heaps, sorting by key, choosing earliest/latest/smallest feasible option.
...
## Implementation
Use the canonical implementation link when one exists: [[Python - Greedy]]. Keep problem-specific code inside [[Problem Index]] pages and avoid copying full template code here.

## Complexity
Often O(n log n) from sorting or heap operations; proof quality matters more than syntax.
...
## Related Algorithms
- [[Heap]], [[Sorting]], [[Interval Processing]]
- [[Algorithm Index]]
