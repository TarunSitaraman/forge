...
type: pattern
status: stable
tags: [dsa/pattern, dsa/meet-in-the-middle]
canonical: true
related: [[[Python - Meet in the Middle]], [[Binary Search]], [[Hashing]], [[Backtracking]], [[Complexities Cheat Sheet]]]
---
# Meet in the Middle

## Intuition
Split exponential search into two halves and combine summarized results.

## When To Use
Subset sums around n=30-40, bidirectional search, combinatorial optimization.
...
## Implementation
Use the canonical implementation link when one exists: [[Python - Meet in the Middle]]. Keep problem-specific code inside [[Problem Index]] pages and avoid copying full template code here.

## Complexity
Often O(2^(n/2) log 2^(n/2)) time and O(2^(n/2)) space.
...
## Related Algorithms
- [[Binary Search]], [[Hashing]], [[Backtracking]]
- [[Algorithm Index]]
