...
type: pattern
status: stable
tags: [dsa/pattern, dsa/dfs]
canonical: true
related: [[[Python - DFS Recursive]], [[Python - DFS Iterative]], [[Graph Traversal]], [[Tree Traversal]], [[Backtracking]], [[DFS Cheat Sheet]]]
---
# DFS

## Intuition
Explore depth-first by following one branch before backtracking to alternatives.

## When To Use
Reachability, connected components, trees, recursion, topological reasoning, exhaustive search.
...
## Implementation
Use the canonical implementation link when one exists: [[Python - DFS Recursive]], [[Python - DFS Iterative]]. Keep problem-specific code inside [[Problem Index]] pages and avoid copying full template code here.

## Complexity
O(V+E) for graph traversal; recursion or stack space is O(depth).
...
## Common Bugs
[[Missing Visited Set]], [[Recursion Depth]], [[Infinite Loop]]
...
## Related Algorithms
- [[Graph Traversal]], [[Tree Traversal]], [[Backtracking]]
- [[Algorithm Index]]
...
## Python Templates
- [[Python - DFS Recursive]], [[Python - DFS Iterative]]
