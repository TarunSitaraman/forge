...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/0-1-knapsack]
canonical: true
...
## Overview
Dynamic program choosing each item at most once under capacity constraints.
...
## Complexity
O(nW) time and O(W) optimized space.
...
## Applications
Resource allocation, subset selection, and feasibility variants.
