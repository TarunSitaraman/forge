...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/fast-exponentiation]
canonical: true
related: [[[Bit Manipulation]], [[Recursion]]]
---
# Fast Exponentiation

## Overview
Computes powers by repeated squaring using binary decomposition of the exponent.
...
## Applications
Modular power, matrix power, and repeated composition.
