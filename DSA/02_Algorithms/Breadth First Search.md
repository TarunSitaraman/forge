...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/breadth-first-search]
canonical: true
related: [[[BFS]], [[Graph Traversal]]]
---
# Breadth First Search

## Overview
Layered graph traversal that discovers shortest unweighted paths.
...
## Applications
Unweighted shortest paths, levels, and minimum-move state search.
