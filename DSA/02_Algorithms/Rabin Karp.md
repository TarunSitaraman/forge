...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/rabin-karp]
canonical: true
related: [[[Hashing]], [[Sliding Window]]]
---
# Rabin Karp

## Overview
String matching with rolling hashes for efficient candidate comparison.
...
## Complexity
Expected O(n+m), worst-case O(nm) with adversarial collisions unless verified.
...
## Applications
Multiple pattern matching, substring fingerprints, and plagiarism-style detection.
