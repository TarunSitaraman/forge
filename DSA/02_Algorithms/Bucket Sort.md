...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/bucket-sort]
canonical: true
related: [[[Array]], [[Hashing]]]
---
# Bucket Sort

## Overview
Distribution sort that partitions values into buckets and sorts within each bucket.
...
## Complexity
Expected O(n+k) under distribution assumptions.
...
## Applications
Uniform numeric distributions and external grouping tasks.
