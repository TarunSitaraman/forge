...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/sieve-of-eratosthenes]
canonical: true
related: [[[Number Theory]], [[Array]]]
---
# Sieve of Eratosthenes

## Overview
Marks composite numbers to enumerate primes up to a limit.
...
## Applications
Prime tables, factorization preprocessing, and number theory constraints.
