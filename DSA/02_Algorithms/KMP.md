...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/kmp]
canonical: true
related: [[[Prefix Sum]], [[String Matching]]]
---
# KMP

## Overview
String matching algorithm that reuses prefix information to avoid rescanning text.
...
## Complexity
O(n+m) time and O(m) space for pattern length m.
...
## Applications
Exact substring search, repeated pattern detection, and streaming-friendly matching.
