...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/dijkstra]
canonical: true
...
## Complexity
O((V+E) log V) with adjacency list and binary heap.
...
## Applications
Routing, weighted state search, latency minimization, and path planning without negative edges.
