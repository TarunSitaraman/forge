...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/kosaraju]
canonical: true
...
## Overview
Two-pass DFS algorithm for strongly connected components using graph reversal.
...
## Complexity
O(V+E) time and O(V+E) space with reversed graph.
...
## Applications
SCC decomposition when a reversed graph is easy to build.
