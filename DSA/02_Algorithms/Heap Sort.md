...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/heap-sort]
canonical: true
related: [[[Heap]], [[Array]]]
---
# Heap Sort
...
## Overview
Comparison sort that builds a heap and repeatedly extracts the extremum.
...
## Complexity
O(n log n) time, O(1) auxiliary space for in-place variant.
...
## Applications
Memory-constrained sorting with deterministic worst-case bounds.
