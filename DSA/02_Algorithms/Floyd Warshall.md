...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/floyd-warshall]
canonical: true
...
## Overview
All-pairs shortest paths dynamic program over intermediate vertices.
...
## Applications
Dense small graphs, transitive closure variants, and distance matrices.
