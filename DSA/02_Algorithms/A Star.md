...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/a-star]
canonical: true
related: [[[Heap]], [[Graph Traversal]]]
---
# A Star

## Overview
Best-first shortest path search guided by an admissible heuristic.
...
## Complexity
O(E log V) in the worst case with heap, often less with strong heuristics.
...
## Applications
Pathfinding on grids, navigation, and state-space search with domain heuristics.
