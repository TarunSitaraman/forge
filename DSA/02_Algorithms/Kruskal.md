...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/kruskal]
canonical: true
related: [[[Union Find]], [[Greedy]]]
---
# Kruskal

## Overview
Minimum spanning tree algorithm that sorts edges and unions components greedily.
...
## Applications
Sparse graph MSTs and clustering by connectivity threshold.
