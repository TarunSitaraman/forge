...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/selection-sort]
canonical: true
related: [[[Array]]]
---
# Selection Sort
...
## Overview
Repeatedly selects the minimum remaining element and places it next.
...
## Applications
Rarely preferred except for educational invariants or very small memory-write-sensitive cases.
