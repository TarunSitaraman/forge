...
type: algorithm
status: stable
tags: [dsa/algorithm, dsa/bellman-ford]
canonical: true
related: [[[Dynamic Programming]], [[Graph]]]
---
# Bellman Ford

## Overview
Single-source shortest paths that tolerates negative edges and detects reachable negative cycles.
...
## Applications
Currency arbitrage, graphs with negative costs, and validation before using Dijkstra.
